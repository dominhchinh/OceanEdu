...
router.post('/user/create', validate(authValidate.register), ErrorHandler(AuthController.register));
router.post('/upload', AuthGuard, ErrorHandler(AuthController.uploadImage));
